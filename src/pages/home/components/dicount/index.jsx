        ...
        <div className="discount-row">
          ...
          <Swiper
            ...
            <SwiperSlide className='discount-card'>
              ...
              <div className='discount-card_info'>
                <span className='discount-card_info_dis'>10% OFF</span>
                {/* <span className='discount-card_info_new'>NEW</span> */}
                {/* <span className='discount-card_info_best'>BEST SELLER</span> */}
                {/* <span className='discount-card_info_top'>TOP RATED</span> */}
              </div>
